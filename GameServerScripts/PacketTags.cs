public static class PacketTags
{
    ...
    public static readonly ushort PlayerPosition = 2; //Client sends 7 floats, Server sends 8 floats and a string.
    public static readonly ushort PlayerEnteredRenderDistance = 14; //Client sends 7 floats, Server sends 8 floats and a string.

    public static readonly ushort Heartbeat = 3; //Server sends empty. (Client and server uses as a proxy for Pinging).
    ...
    public static readonly ushort ClientToWorldServerAuthentication = 9; //CLient sends ulong to WorldServer,  WorldServer sends ulong to LoginServer. WorldServer responds bool from LoginServer to Client.
